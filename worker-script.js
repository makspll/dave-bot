...
const COMMANDS = {
    ...
    "attack": async (payload, args) => {
        if (payload.message.from.id == ENV.GOD_ID) {
            ...
            let gpt_answer = await call_gpt(SYSTEM_PROMPT + "." + "RELATIONSHIP_SUMMARY: " + "They've just angered all your gods and friends" + ". PROMPT: " + "Absolutely destroy them in one sentence (in a friendly way of course)", [])
